        ...
        <div class="panel panel-green">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped" id="dataTables-example">
                    <tr>
                        <td><strong>Assignment No:</strong></td>
             ...
             <div class="panel-body">
                ...
                <%
                   ...
                   var projectz = Config.ReturnNav().collabResourceAllocation.Where(r => r.Account_No == Convert.ToString(Session["PeerCode"]) && r.Code == ids && r.Status == "Approved");
                    foreach (var project in projectz)
                    {
                        //check if the peer reviewer has reviewed
                        acceptedC = Convert.ToBoolean(project.Job_Accepted);
                        if (!acceptedC)
                        {
                %>
                <div class="alert alert-info">
                    ...
                    <ul>
                      ...
                      <%} %>--%>
                        ...
                        <%}
                            ...
                            else if (projectType == "Quality Audit")
                            {
                        ...
                        <%}
                                    ...
                                    {
                                        var conflictsCollab = nav.ConflictOfInterest.Where(x => x.Type == "Collaboration").ToList();
                                        foreach (var conflict in conflictsCollab)
                                        {%>
                        <li><%=conflict.Item_Description %></li>
                        <%}
                            }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                      ...
                      <%} %>--%>
                            <% 
                                string projectTypes = Request.QueryString["projectType"];
                                if (projectTypes == "Accreditation")
                                {
                                    var conflicts = nav.ConflictOfInterest.Where(x => x.Type == "Accreditation").ToList();
                                    foreach (var conflict in conflicts)
                                    {%>
                            ...
                            <%}
                                ...
                                else if (projectTypes == "Quality Audit1")
                                {
                                    var conflicts = nav.ConflictOfInterest.Where(x => x.Type == "Quality Audit").ToList();
                                    foreach (var conflict in conflicts)
                                    {%>
                            ...
                            <%}
                                ...
                                else if (projectTypes == "Curriculum Document Review")
                                {
                                    var conflictsCollab = nav.ConflictOfInterest.Where(x => x.Type == "Collaboration").ToList();
                                    foreach (var conflict in conflictsCollab)
                                    {%>
                            ...
                            <%}
                                ...
                                else if (projectTypes == "Verification of Academic Resources")
                                {
                                    var conflictsCollab = nav.ConflictOfInterest.Where(x => x.Type == "Collaboration").ToList();
                                    foreach (var conflict in conflictsCollab)
                                    {%>
