<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Land.aspx.cs" Inherits="CicPortal.Land" %>
    ...
    <div class="row" style="width: 100%; margin: 5px;">
        <div class="panel panel-default">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" CssClass="form-control" ID="landSize" placeholder="Land Size (Acres)" required/>
                        </div>
                    </div>  
                     <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            <strong>LR Number:</strong>
                            <asp:TextBox runat="server" CssClass="form-control" ID="lRNumber" Placeholder ="LR Number" required/>
                        </div>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            <strong>Title Deed (Copy):</strong>
                            <asp:FileUpload runat="server" CssClass="form-control" ID="titleDeed"  required/>
                        </div>
                    </div>  
            ...
            <div class="panel-footer">
                <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Add Land"/>
