...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="margin: 10px;">
        ...
        <div class="panel panel-green">
            <div class="panel-heading">Ongoing Institution collaboration Curriculum Document Review</div>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="JsTable1">
                        ...
                        <tbody>
                            <%
                                var projectData4 = Config.ReturnNav().collabResourceAllocation.Where(r => r.Account_No == Convert.ToString(Session["PeerCode"]) && r.Status == "Approved" && r.Confirmed == true && r.Project_Type == "Curriculum Document Review" && r.Appoint == true).ToList();
                                foreach (var project in projectData4)
                                {
                            %>
                            ...
                            <tr>
                                ...
                                <td><%=Convert.ToDateTime(project.Tentative_End_Date).ToShortDateString() %></td>
                                <td>
                                    <label class="btn btn-success" onclick="addCollabcomments('<%=project.Code %>','<%=project.Job_No %>','<%=project.Account_No %>','<%=project.Project_Type %>')"><i class="fa fa-eye"></i>View Details</label></td>
                                <td><a href="DownloadCurriculum.aspx?applicationNo=<%=project.Job_No %>" class="btn btn-info"><i class="fa fa-download"></i>Download Curriculum</a></td>
                                <td><a visible="false" href="Evaluation_Component.aspx?ApplicationNo=<%=project.Job_No %>"></a></td>
                            </tr>
                            <%
        ...
        <div class="panel panel-green">
            <div class="panel-heading">Ongoing Institution Collaboration Verification of Academic Resources Tasks</div>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <%
                                var projectData5 = Config.ReturnNav().collabResourceAllocation.Where(r => r.Account_No == Convert.ToString(Session["PeerCode"]) && r.Status == "Approved" && r.Confirmed == true && r.Project_Type == "Verification of Academic Resources" && r.Appoint == true);
                                foreach (var project in projectData5)
                                {
                            %>
                            ...
                            <tr>
                                ...
                                <td><%=Convert.ToDateTime(project.Tentative_End_Date).ToShortDateString() %></td>
                                <td>
                                    <label class="btn btn-success" onclick="addCollabVerifcomments('<%=project.Code %>','<%=project.Job_No %>','<%=project.Account_No %>','<%=project.Project_Type %>')"><i class="fa fa-eye"></i>View Details</label></td>
                                <td><a href="DownloadCurriculum.aspx?applicationNo=<%=project.Job_No %>" class="btn btn-info"><i class="fa fa-download"></i>Download Curriculum</a></td>
                                <td><a visible="false" href="Evaluation_Component.aspx?ApplicationNo=<%=project.Job_No %>"></a></td>
                            </tr>
                            <%
                ...
                <table class="table table-bordered table-striped dataTable1">
                    ...
                    <tbody>
                        <%
                            ...
                            var pg = Config.ReturnNav().programmeSiteEvaluation.Where(x => x.Resource_No == Convert.ToString(Session["PeerCode"]) && x.Status == "Open");
    ...
    <div class="row" style="margin: 10px;">
        ...
        <div class="panel panel-green">
            <div class="panel-heading">Unsubmitted Collaboration Tasks</div>
            <div runat="server" id="Div6"></div>
            <h4 style="color:blue"><strong>Assignment on curriculum Document evaluation (Individual)</strong></h4>
            <div class="panel-body">
                <table class="table table-bordered table-striped dataTable1">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            ...
                            var IndividualCurreval = Config.ReturnNav().UnsubmittedIndividualC.Where(x =>x.Type=="Individual" && x.Project_Type=="Curriculum Document Review" && x.Resource_No == Convert.ToString(Session["PeerCode"]) && x.Status == "Open");
                            foreach (var project in IndividualCurreval)
                            {
                        %>
                        ...
                        <tr>
                            ...
                            <td><%=Convert.ToDateTime(project.Created_On).ToShortDateString() %></td>
                            <td><%=project.Status %></td>
                            <td><a class="btn btn-info" href="Evaluation_Component.aspx?evalNo=<%=project.Code %>&&ApplicationNo=<%=project.Application_No %>&&type=<%=project.Project_Type %>"><i class="fa fa-pencil"></i>Edit Evaluation</a></td>
                        </tr>
                        <%
                            }
      ...
      <h4 style="color:blue"><strong>Assignment on curriculum Document evaluation (Group)</strong></h4>
           <div class="panel-body">
                <table class="table table-bordered table-striped dataTable1">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            ...
                            var groupCD=  Config.ReturnNav().UnsubmittedIndividualC.Where(x =>x.Type=="Group" && x.Project_Type=="Curriculum Document Review" && x.Resource_No == Convert.ToString(Session["PeerCode"]) && x.Status == "Open" && x.Published==true && x.Final_Report_Generated==false);
                            foreach (var project in groupCD)
                            {
                        %>
            ...
            <h4 style="color:blue"><strong>Assignment on site Inspection</strong></h4>
           <div class="panel-body">
                <table class="table table-bordered table-striped dataTable1">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <%
                            ...
                            var verificationRcs = Config.ReturnNav().UnsubmittedIndividualC.Where(x =>x.Type=="Verification of Academic Resources" && x.Project_Type=="Verification of Academic Resources" && x.Resource_No == Convert.ToString(Session["PeerCode"]) && x.Status == "Open");
                            foreach (var project in verificationRcs)
                            {
                        %>
    ...
    <script>
        function addauditcomments(applicationNo) {
          ...
          <script>
            function addCollabcomments(lineno, applicationNo, resource, type) {
                document.getElementById("MainContent_editLineno1").value = lineno;
                document.getElementById("MainContent_editapp1").value = applicationNo;
                document.getElementById("MainContent_editresource1").value = resource;
                document.getElementById("MainContent_edittype1").value = type;
            $("#addcommentsCollbModal").modal();
        }
    </script>
       <script>
         function addCollabVerifcomments(lineno, applicationNo, resource, type) {
             document.getElementById("MainContent_editLineno2").value = lineno;
             document.getElementById("MainContent_editapp2").value = applicationNo;
             document.getElementById("MainContent_editresource2").value = resource;
             document.getElementById("MainContent_edittype2").value = type;
            $("#addcommentsCollbVerifModal").modal();
        }
    </script>

       <div id="addcommentsCollbModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:TextBox runat="server" ID="editLineno1" type="hidden" />
                    <asp:TextBox runat="server" ID="editapp1" type="hidden" />
                    <asp:TextBox runat="server" ID="editresource1" type="hidden" />
                    <asp:TextBox runat="server" ID="edittype1" type="hidden" />
                    <div class="form-group">
                        <strong>Evaluation Type:</strong>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="evaltype1" AutoPostBack="true" OnSelectedIndexChanged="EvaluationType_SelectedIndexChanged1">
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button runat="server" CssClass="btn btn-success" Text="Add Comments" ID="AddcommentCollab" OnClick="AddcommentCollab_Click" />
                </div>
            </div>
        </div>
    </div>

        <div id="addcommentsCollbVerifModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <asp:TextBox runat="server" ID="editLineno2" type="hidden" />
                    <asp:TextBox runat="server" ID="editapp2" type="hidden" />
                    <asp:TextBox runat="server" ID="editresource2" type="hidden" />
                    <asp:TextBox runat="server" ID="edittype2" type="hidden" />
                    <div class="form-group">
                        <strong>Evaluation Type:</strong>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="evaltype2">
                            <asp:ListItem Value="0">--select--</asp:ListItem>
                             <asp:ListItem Value="3">Verification of Academic Resources</asp:ListItem>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning pull-left" data-dismiss="modal">Close</button>
                    <asp:Button runat="server" CssClass="btn btn-success" Text="Add Comments" ID="AddCommentsVer" OnClick="AddCommentsVer_Click" />
                </div>
            </div>
        </div>
    </div>
